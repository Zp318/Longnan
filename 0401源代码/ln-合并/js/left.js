$(function(){
	...
	var shOption = {
	    ...
	    xAxis:  {
	        type: 'category',
	        boundaryGap: false,
	        data: ['2016Q1','2016Q2','2016Q3','2016Q4'],
	        axisLabel : {
	        	textStyle : {
	        		color : '#fff'
	        	}
	    ...
	    series: [
	        {
	            name:'城镇人均可支配收入',
	            type:'line',
	            data:[3134.7, 7901.7, 15021.06, 20211.46]
	        },
	        {
	            name:'农村人均可支配收入',
	            type:'line',
	            data:[1285.9, 2952.6, 4381.1, 5853.5]
	        }/*,
	        {
	            name:'城镇人均收入较上年增长',
	            type:'line',
	            data:[1300, 1400, 1500, 1600]
	        },
	        {
	            name:'农村人均收入较上年增长',
	            type:'line',
	            data:[500, 800, 1200, 1400]
	        }*/
	    ]
	};
	...
	var hjOption = {
	    ...
	    xAxis: {
	        type: 'category',
	        data: ['06.26','06.27','06.28','06.29','06.30','07.01','07.02','07.03','07.04','07.05',],
	        axisLabel : {
	        	textStyle : {
	        		color : '#fff'
	        	}
	    ...
	    series: [
	        {
	            ...
	            data: [49, 46, 41, 46, 45, 41, 52, 45, 43, 30]
	        }
	    ]
	};
	    ...
	    series : [
	        {
	            ...
	            data:[1.32, 2.17, 1.9, 4.13441, 2.14171, 1.5939, 1.2623]
          	},
          	{
	            name:'公共预算支出',
	            type:'line',
	            ...
	            data:[20.56, 9.84, 23.83, 25.74661, 12.1483, 6.983, 26.5886]
          	}/*,
          	{
	            name:'金融机构各项存款',
	            type:'line',
	            ...
	            data:[null, null, null, null, 779.78, 789.87, 801.01]
          	},
          	{
	            name:'金融机构各项贷款',
	            type:'line',
	            ...
	            data:[null, null, null, null, 570.3, 570.56, 580.54]
          	}*/
	    ]
	  };
